...
# 500 epochs take 24 hours, each epoch consists of 105 train steps
batch_size = 30
num_epochs = 5
...
def run_training():
	...
	global_step = tf.Variable(0, name='global_step', trainable=False)
        ...
        logits = gg.inference(images_batch, motions_batch, is_training,keep_prob)
	...
	# accuracy of the trained model
        #correct_prediction = tf.less_equal(tf.abs(tf.subtract(y, labels_batch)), 0.4)
	...
	merged_summary_op = tf.summary.merge_all()
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                _, loss_value, accuracy_value, summary = sess.run([train_op, loss, accuracy, merged_summary_op], feed_dict={is_training: True})
