	...
	merged_summary_op = tf.summary.merge_all()
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                _, loss_value, accuracy_value, global_step_value, summary = sess.run([train_op, loss, accuracy,global_step, merged_summary_op], feed_dict={is_training: True})
